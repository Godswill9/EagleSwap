...
export default function FarmsEarnAlt(){
    ...
    <div>
        ...
        {/* <div className='imgg' style={{"visibility":"hidden"}}> */}
               ...
               {/* <div style={{color:boxObj.moreText.button2.colorr2, border:`.2px solid ${boxObj.moreText.button2.colorr2}`, boxShadow:`0 3px 1px ${boxObj.moreText.button2.colorr2}`}} className='text'>FARMS: Earn other Tokens</div>
            </div> */}
